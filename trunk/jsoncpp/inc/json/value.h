...
namespace Json {
   ...
   enum ValueType
   {
      ...
      int64Value   = 8,   ///< signed integer 64 value
      uint64Value  = 9,   ///< unsigned integer 64 value
   };
...
#ifndef JSON_VALUE_USE_INTERNAL_MAP
	ObjectValues::const_iterator Begin() const;
	ObjectValues::const_iterator End() const;
#endif
